...
//TRObject
   ...
   namespace traits {
      ...
      public:
         Exporter(SEXP x) { t = *Rcpp::XPtr<funprt>(x).get(); }
         funprt get() { return t; }
      private:
         funprt t;
      };
      ...
      public:
         Exporter(SEXP x) { t = *Rcpp::XPtr<cfunprt>(x).get(); }
         cfunprt get() { return t; }
      private:
         cfunprt t;
      };
      ...
      public:
         Exporter(SEXP x) { t = Rcpp::as<TString>(x); }
         ccharptr get() { return t; }
      private:
         ccharptr t;
      };
   }

...
namespace TMVA {
   ...
   protected:
       ...
       Int_t n_estimators=10;//integer, optional (default=10)
                             //The number of trees in the forest.
       TString criterion="gini";//string, optional (default="gini")
                                //The function to measure the quality of a split. Supported criteria are
                                //"gini" for the Gini impurity and "entropy" for the information gain.
                                //Note: this parameter is tree-specific.
       TString max_depth="None";//integer or None, optional (default=None)
                         //The maximum depth of the tree. If None, then nodes are expanded until
                         //all leaves are pure or until all leaves contain less than
                         
       Int_t min_samples_leaf=1;//integer, optional (default=1)
                              //The minimum number of samples in newly created leaves.  A split is
                              //discarded if after the split, one of the leaves would contain less then
                              //``min_samples_leaf`` samples.
                              //Note: this parameter is tree-specific.
       Float_t min_weight_fraction_leaf=0;//float, optional (default=0.)
                                        //The minimum weighted fraction of the input samples required to be at a
                                        //leaf node.
                                        //Note: this parameter is tree-specific.
       Bool_t bootstrap=kTRUE;//boolean, optional (default=True)
                              //Whether bootstrap samples are used when building trees.
       
       Int_t n_jobs=1;// : integer, optional (default=1)

...
namespace TMVA {
   ...
   public:
      ...
      std::ostringstream &GetStingStream(){return fMsg;}
   ...
   private:
      ...
      ClassDef(MsgLogger,1); // Ostringstream derivative to redirect and format logging output
   }; // class MsgLogger

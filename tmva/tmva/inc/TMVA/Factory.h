...
namespace TMVA {
   ...
   public:
      ...
      float CrossValidate(DataLoader *loader, Types::EMVA theMethod,  TString methodTitle, const char *theOption = "", bool optParams = false, int NumFolds = 5, bool remakeDataSet = true);
